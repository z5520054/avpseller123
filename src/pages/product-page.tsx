        ...
        <div className="satin-panel rounded-[32px] border border-white/10 p-6 lg:p-8">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            {isInCart ? (
              <Link
                to="/cart"
                className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-full border border-emerald-300/60 bg-emerald-400 px-6 py-3 text-sm font-medium text-black shadow-[0_0_32px_rgba(52,211,153,0.48)] transition hover:bg-emerald-300"
              >
                <ShoppingBag size={16} />
                Перейти в корзину
              </Link>
